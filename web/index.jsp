<%-- 
    Document   : index
    Created on : 26-ago-2019, 12:09:31
    Author     : xxx
--%>
            ...
            <div class="card-body">
                <form class="form-sign" action="Controlador" method="Post">
                    <div class="form-group text-center">
                        ...
                        <label>Tienda de celulares<label/>
                    </div>
                    <div class="form-group">
                        <input type="txt" name="nombreUsuario" class="form-control" placeholder="Nombre de usuario"  required="required">
                    </div>
                    <div class="form-group">
